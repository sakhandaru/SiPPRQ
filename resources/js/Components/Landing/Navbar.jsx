        ...
        <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                ...
                <div className="flex items-center gap-3">
                    <img src="/logoRQkecil.png" alt="Logo" className="w-10 h-10 object-contain" />
                    <div className={`font-bold text-lg md:text-xl tracking-tight transition-colors ${scrolled ? 'text-gray-900' : 'text-white'}`}>
                        PP. Raudhatul Qur'an Annasimiyyah
                    </div>
                </div>
